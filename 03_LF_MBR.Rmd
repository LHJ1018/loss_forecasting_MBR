...
QTRS = c('2021_Q3', '2021_Q4', '2022_Q1', '2022_Q2')
...
## Go-Forward Expectations -- Core T1-T4 -- CP `r CUR_CP`
...
## Go-Forward Expectations -- Tier 4 -- CP `r CUR_CP`
```{r, dpi=320, fig.width=10.6, fig.height=5}
TIER = 'Tier 4'
forward_vin_por_plot(DF_V[segment == TIER], DF_P[segment == TIER], aDF[segment == TIER])
```
...
## Core T1-T4 -- CP `r CUR_CP` -- Actual vs Expected Charge Off
